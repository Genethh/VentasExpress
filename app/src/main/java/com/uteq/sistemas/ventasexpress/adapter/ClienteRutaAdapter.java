...
import com.uteq.sistemas.ventasexpress.fragment.VendedorRutaAgregarClienteFragment;
 ...
 */
public class ClienteRutaAdapter extends RecyclerView.Adapter<ClienteRutaAdapter.ViewHolder> {

    Context context;
    List<Cliente> clientes;
    String id;

    public ClienteRutaAdapter(Context context, List<Cliente> clientes, String id) {
        ...
        public ViewHolder(View item) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    b.putString("idpedido", (String) direccion.getText());
                    Fragment fragment = new VendedorRutaAgregarClienteFragment();
