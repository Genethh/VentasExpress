 ...
 */
public class AdministradorCategoriasNuevoProductoFragment extends Fragment  implements Asynchtask {
    Fragment fragment;
    ...
    public AdministradorCategoriasNuevoProductoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_administrador_categorias_nuevo_producto, container, false);
    ...
    private void ConectWS() {
        ...
        params.put("lista", "1");
        WebService ws = new WebService(Constants.WS_CATEGORIA, params, view.getContext(), (Asynchtask) AdministradorCategoriasNuevoProductoFragment.this);
        ws.execute("");
    }
    ...
    public void processFinish(String result) throws JSONException {
        ...
        CategoriaNuevoProductoAdapter adapater = new CategoriaNuevoProductoAdapter(view.getContext(), categorias);
